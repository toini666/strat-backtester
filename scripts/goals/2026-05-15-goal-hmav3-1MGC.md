...
- **Timeframes prioritaires à explorer**: `5m, 7m, 10m`

- **Preset de départ (optionnel)**: Partir du preset qui est sauvegardé dans mes favoris sous le nom: `HMASSLOsciV2 - MGC 7m - Goalbaseline`
