"""Phase 1 — Selectivity (thresholds + gap + candle filter).

The 0c probe found min_gap=8 already gives +$12.6k PnL (DD too high but PnL OK).
This phase focuses on those entry-gating params with denser grids:
  - long_threshold, short_threshold (separately + jointly)
  - min_gap (5..12)
  - max_candle_pct
"""
