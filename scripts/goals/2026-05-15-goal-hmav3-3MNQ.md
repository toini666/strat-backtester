...
- **Preset de départ (optionnel)**: Partir du preset gagnant de la dernière itération sur MNQ (issu de la campagne dans le dossier 2026-05-16_HMASSLOsciV3_MNQ_v3)
...
- Profit net total: atteindre le maximum en 250 simulations + PNL doit être plus grand que **> 35 000$**
