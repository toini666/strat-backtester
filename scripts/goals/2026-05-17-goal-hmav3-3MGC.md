...
- **Timeframes prioritaires à explorer**: `7m uniquement`

- **Preset de départ (optionnel)**: Partir du preset gagnant de la dernière itération sur MGC (issu de la campagne dans le dossier 2026-05-16_HMASSLOsciV3_MGC_v2)
...
- Profit net total: atteindre le meilleur pnl en 200 simulations tout en respectant le max drawdown ci-dessous
- Max drawdown: atteindre un max drawdown en dessous de **< 2 000 $**
