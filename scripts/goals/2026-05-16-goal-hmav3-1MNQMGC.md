...
- **Preset de départ (optionnel)**: Partir du preset sauvegardé dans les favoris du repo sous le nom: HMA-SSL-V3 - MNQ/MGC - Best
...
- Profit net total: atteindre le maximum en 250 simulations + PNL doit être plus grand que **> 100 000$**
