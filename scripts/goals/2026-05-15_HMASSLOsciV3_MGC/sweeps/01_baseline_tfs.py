"""Sweep 01 — Baseline timeframes for HMASSLOsciV3 on MGC.

Run native default_params across all priority + extra TFs, report PnL/DD/PF.
Identify best TF by Profit/DD ratio.
"""
...
from scripts.goals._shared.harness import bench, summarize
