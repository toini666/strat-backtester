...
- **Timeframes prioritaires à explorer**: `7m en priorité, 10m en alternative`

- **Preset de départ (optionnel)**: Partir du preset gagnant de la première itération (issu de la campagne dans le dossier 2026-05-15_HMASSLOsciV3_MNQ_v2) mais en démarrant sans tous les blackouts (garder uniquement comme point de départ le blackout de 22:00 à 23:59)
...
- Profit net total: essayer d'améliorer et d'atteindre les **> 40 000 $** mais respecter au minimum **> 35 000 $**
- Max drawdown garder le drawdown en dessous de **< 2 500 $**
