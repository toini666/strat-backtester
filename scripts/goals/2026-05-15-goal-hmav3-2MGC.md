...
- **Preset de départ (optionnel)**: Partir du preset gagnant de la première itération (issu du goal HMASSLOsciV3_MGC) mais en démarrant sans tous les blackouts (garder uniquement comme point de départ le blackout de 22:00 à 23:59)
