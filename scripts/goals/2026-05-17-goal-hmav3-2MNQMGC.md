...
- **Preset de départ (optionnel)**: Partir du preset sauvegardé dans les favoris du repo sous le nom: Multi-Asset — MNQ/MGC - NEW
...
- Profit net total: atteindre le maximum en 200 simulations + PNL doit rester plus grand que **> 100 000$**
- Max drawdown: passer le max drawdown combiné en dessous de **< 2 000 $**
