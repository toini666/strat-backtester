...
- **Stratégie à étudier** *(une seule)* :
  - `EMABreakOsc` · `EMA9Scalp` · `UTBotAlligatorST` · `HMAOsci`
  - `HMASSLOsci` · `HMASSLOsciV2` · `HMASSLOsciV3`
  - `EMABreakHMASSLOsc` · `RobReversal` · `GatorHMAEpure`

- **Nom de la stratégie duplicate à créer** : `<Strategy>Lab` (ex. `HMASSLOsciV3Lab`)
...
- **Presets gagnants de référence** *(min. 1, max. 3)* :
  - `scripts/goals/<dossier1>/winner_preset.json`
  - `scripts/goals/<dossier2>/winner_preset.json`
  - `scripts/goals/<dossier3>/winner_preset.json`
...
- **Période** : reprend celle des presets de référence (généralement `2025-01-06` → `2026-05-15`).
