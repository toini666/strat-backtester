...
def _run_simulator_backtest(
    ...
    config = SimulatorConfig(
        ...
        one_trade_per_window_mtf=bool(simulator_settings.get("one_trade_per_window_mtf", False)),
        ...
        tp_mode_slow_hma_cross=bool(simulator_settings.get("tp_mode_slow_hma_cross", False)),
